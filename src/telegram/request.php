...
use BPT\BPT;
use BPT\types\businessConnection;
use BPT\types\linkPreviewOptions;
use BPT\types\reactionType;
use BPT\types\replyParameters;
use BPT\types\userChatBoosts;
 ...
 * @method static messageId[]|responseError copyMessages (int|string|array $chat_id, int[] $message_ids, int|null $message_thread_id = null, int|string|null $from_chat_id = null, bool|null $disable_notification = null, bool|null $protect_content = null, bool|null $remove_caption = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to copy messages of any kind. If some of the specified messages can't be found or copied, they are skipped. Service messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz poll can be copied only if the value of the field correct_option_id is known to the bot. The method is analogous to the method forwardMessages, but the copied messages don't have a link to the original message. Album grouping is kept for copied messages. On success, an array of MessageId of the sent messages is returned.
 * @method static messageId[]|responseError copies (int|string|array $chat_id, int[] $message_ids, int|null $message_thread_id = null, int|string|null $from_chat_id = null, bool|null $disable_notification = null, bool|null $protect_content = null, bool|null $remove_caption = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to copy messages of any kind. If some of the specified messages can't be found or copied, they are skipped. Service messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz poll can be copied only if the value of the field correct_option_id is known to the bot. The method is analogous to the method forwardMessages, but the copied messages don't have a link to the original message. Album grouping is kept for copied messages. On success, an array of MessageId of the sent messages is returned.
 * @method static message|responseError sendPhoto (CURLFile|string|array|object $photo, int|string|null $chat_id = null, string|null $business_connection_id = null, int|null $message_thread_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null $caption_entities = null, bool|null $has_spoiler = null, bool|null $disable_notification = null, bool|null $protect_content = null, replyParameters|object|array|null $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|object|array|null $reply_markup = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null) Use this method to send photos. On success, the sent Message is returned.
 ...
 * @method static string|responseError exportChatInviteLink (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to generate a new primary invite link for a chat;
 ...
 * @method static string|responseError link (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to generate a new primary invite link for a chat;
* any previously generated primary link is revoked. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Returns the new invite link as String on success.
 ...
 * @method static chat|responseError getChat (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get up to date information about the chat. Returns a Chat object on success.
 * @method static chat|responseError chat (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get up to date information about the chat. Returns a Chat object on success.
 ...
 * @method static userChatBoosts|responseError getUserChatBoosts (int|string|array|null $chat_id = null, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get the list of boosts added to a chat by a user. Requires administrator rights in the chat. Returns a UserChatBoosts object.
 * @method static userChatBoosts|responseError chatBoosts (int|string|array|null $chat_id = null, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get the list of boosts added to a chat by a user. Requires administrator rights in the chat. Returns a UserChatBoosts object.
 * @method static businessConnection|responseError getBusinessConnection (string|array $business_connection_id, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get information about the connection of the bot with a business account. Returns a BusinessConnection object on success.
 * @method static businessConnection|responseError getBusiness (string|array $business_connection_id, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get information about the connection of the bot with a business account. Returns a BusinessConnection object on success.
 ...
 * @method static bool|responseError deleteMessages (int[]|array $message_ids, int|string|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to delete multiple messages simultaneously. If some of the specified messages can't be found, they are skipped. Returns True on success.
 * @method static bool|responseError dels (int[]|array $message_ids, int|string|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to delete multiple messages simultaneously. If some of the specified messages can't be found, they are skipped. Returns True on success.
 ...
 * @method static bool|responseError createSticker (string|array $name, string $title, inputSticker[] $stickers, int|null $user_id = null, string|null $sticker_type = null, bool|null $needs_repainting = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to create a new sticker set owned by a user. The bot will be able to edit the sticker set thus created. Returns True on success.
 ...
 * @method static bool|responseError setStickerSetThumb (string|array $name, int|null $user_id = null, string|null $business_connection_id = null, CURLFile|string|object|null $thumbnail = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must be same with the format of the stickers in the set. Returns True on success.
 * @method static bool|responseError setStickerThumb (string|array $name, int|null $user_id = null, string|null $business_connection_id = null, CURLFile|string|object|null $thumbnail = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must be same with the format of the stickers in the set. Returns True on success.
...
class request {
    ...
    private const METHODS_ACTION = [
        ...
        'chatboosts'                        => 'getUserChatBoosts',
        'getbusinessconnection'             => 'getBusinessConnection',
        'getbusiness'                       => 'getBusinessConnection',
        ...
        'replacesticker'                    => 'replaceStickerInSet',
    ...
    private const METHODS_KEYS = [
        ...
        'sendMessage'                       => ['text', 'chat_id', 'business_connection_id', 'message_thread_id', 'parse_mode', 'entities', 'link_preview_options', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'forwardMessages'                   => ['chat_id', 'message_ids', 'message_thread_id', 'from_chat_id', 'disable_notification', 'protect_content', 'token', 'forgot', 'answer'],
        'copyMessage'                       => ['chat_id', 'message_thread_id', 'from_chat_id', 'message_id', 'caption', 'parse_mode', 'caption_entities', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'copyMessages'                      => ['chat_id', 'message_ids', 'message_thread_id', 'from_chat_id', 'disable_notification', 'protect_content', 'remove_caption', 'token', 'forgot', 'answer'],
        'sendPhoto'                         => ['photo', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAudio'                         => ['audio', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'performer', 'title', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendDocument'                      => ['document', 'chat_id', 'business_connection_id', 'message_thread_id', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'disable_content_type_detection', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideo'                         => ['video', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'supports_streaming', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAnimation'                     => ['animation', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVoice'                         => ['voice', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideoNote'                     => ['video_note', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendMediaGroup'                    => ['media', 'chat_id', 'business_connection_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendLocation'                      => ['latitude', 'longitude', 'chat_id', 'business_connection_id', 'message_thread_id', 'horizontal_accuracy', 'live_period', 'heading', 'proximity_alert_radius', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVenue'                         => ['latitude', 'longitude', 'title', 'address', 'chat_id', 'business_connection_id', 'message_thread_id', 'foursquare_id', 'foursquare_type', 'google_place_id', 'google_place_type', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendContact'                       => ['phone_number', 'first_name', 'chat_id', 'business_connection_id', 'message_thread_id', 'last_name', 'vcard', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendPoll'                          => ['question', 'options', 'chat_id', 'business_connection_id', 'message_thread_id', 'is_anonymous', 'type', 'allows_multiple_answers', 'correct_option_id', 'explanation', 'explanation_parse_mode', 'explanation_entities', 'open_period', 'close_date', 'is_closed', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendDice'                          => ['chat_id', 'business_connection_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendChatAction'                    => ['chat_id', 'business_connection_id', 'message_thread_id', 'action', 'token', 'forgot', 'answer'],
        'setMessageReaction'                => ['chat_id', 'message_id', 'reaction', 'is_big', 'token', 'forgot', 'answer'],
        ...
        'promoteChatMember'                 => ['chat_id', 'user_id', 'is_anonymous', 'can_manage_chat', 'can_delete_messages', 'can_manage_video_chats', 'can_restrict_members', 'can_promote_members', 'can_change_info', 'can_invite_users', 'can_post_stories', 'can_edit_stories', 'can_delete_stories', 'can_post_messages', 'can_edit_messages', 'can_pin_messages', 'can_manage_topics', 'token', 'forgot', 'answer'],
        ...
        'getUserChatBoosts'                 => ['chat_id', 'user_id', 'token', 'forgot', 'answer'],
        'getBusinessConnection'             => ['business_connection_id', 'token', 'forgot', 'answer'],
        ...
        'editMessageText'                   => ['text', 'chat_id', 'message_id', 'inline_message_id', 'parse_mode', 'entities', 'link_preview_options', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'deleteMessages'                    => ['message_ids', 'chat_id', 'token', 'forgot', 'answer'],
        'sendSticker'                       => ['sticker', 'chat_id', 'business_connection_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'createNewStickerSet'               => ['name', 'title', 'stickers', 'user_id', 'sticker_type', 'needs_repainting', 'token', 'forgot', 'answer'],
        ...
        'replaceStickerInSet'               => ['name', 'old_sticker', 'sticker', 'user_id', 'token', 'forgot', 'answer'],
        ...
        'setStickerSetThumbnail'            => ['name', 'format', 'user_id', 'thumbnail', 'token', 'forgot', 'answer'],
        ...
        'sendGame'                          => ['game_short_name', 'chat_id', 'business_connection_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
    ...
    private const METHODS_EXTRA_DEFAULTS = [
        ...
        'getUserChatBoosts'                 => ['user_id', 'chat_id'],
    ...
    private const METHODS_RETURN = [
        ...
        'forwardMessages'                 => ['BPT\types\messageId'],
        'copyMessage'                     => 'BPT\types\messageId',
        'copyMessages'                    => ['BPT\types\messageId'],
        ...
        'getUserChatBoosts'               => 'BPT\types\userChatBoosts',
        'getBusinessConnection'           => 'BPT\types\businessConnection',
    ...
    public static function sendFile (string $file_id, int|string $chat_id = null, string|null $business_connection_id = null, int $message_thread_id = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $disable_notification = null, bool $protect_content = null, array|object $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|stdClass|array $reply_markup = null, string $token = null, bool $forgot = null, bool $answer = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null): message|bool|responseError {
        ...
        return match ($type) {
            fileTypes::VIDEO => request::sendVideo($file_id, $chat_id, $business_connection_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false,null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::VIDEO_NOTE => request::sendVideoNote($file_id, $chat_id, $business_connection_id, $message_thread_id, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::ANIMATION => request::sendAnimation($file_id, $chat_id, $business_connection_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::AUDIO => request::sendAudio($file_id, $chat_id, $business_connection_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::PHOTO, fileTypes::PROFILE_PHOTO => request::sendPhoto($file_id, $chat_id, $business_connection_id, $message_thread_id, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::VOICE => request::sendVoice($file_id, $chat_id, $business_connection_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::STICKER => request::sendSticker($file_id, $chat_id, $business_connection_id, $message_thread_id, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::DOCUMENT => request::sendDocument($file_id, $chat_id, $business_connection_id, $message_thread_id, null, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            default => false,
        };
    }
}
