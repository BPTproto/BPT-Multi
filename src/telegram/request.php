 ...
 * @method static chatMember|responseError getChatMember (int|string|null|array $chat_id = null, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get information about a member of a chat. Returns a ChatMember object on success.
 * @method static chatMember|responseError member (int|string|null|array $chat_id = null, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get information about a member of a chat. Returns a ChatMember object on success.
 ...
 * @method static bool|responseError editForumTopic (int|string|array $chat_id, int $message_thread_id, string $name, string $icon_custom_emoji_id, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError editTopic (int|string|array $chat_id, int $message_thread_id, string $name, string $icon_custom_emoji_id, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
