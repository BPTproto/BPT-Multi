...
use BPT\types\chatFullInfo;
use BPT\types\inputPollOption;
 ...
 * @method static messageId|responseError copyMessage (int|string|array $chat_id, int|null $message_thread_id = null, int|string|null $from_chat_id = null, int|null $message_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null $caption_entities = null, bool|null $show_caption_above_media = null, bool|null $disable_notification = null, bool|null $protect_content = null, string|null $message_effect_id = null, replyParameters|object|array|null $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|object|array|null $reply_markup = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null) Use this method to copy messages of any kind. Service messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz poll can be copied only if the value of the field correct_option_id is known to the bot. The method is analogous to the method forwardMessage, but the copied message doesn't have a link to the original message. Returns the MessageId of the sent message on success.
 ...
 * @method static chatFullInfo|responseError getChat (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get up-to-date information about the chat. Returns a ChatFullInfo object on success.
 * @method static chatFullInfo|responseError chat (int|string|array|null $chat_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get up-to-date information about the chat. Returns a ChatFullInfo object on success.
 ...
 * @method static bool|responseError setStickerSetThumb (string|array $name, string $format, int|null $user_id = null, string|null $business_connection_id = null, CURLFile|string|object|null $thumbnail = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must be same with the format of the stickers in the set. Returns True on success.
 * @method static bool|responseError setStickerThumb (string|array $name, string $format, int|null $user_id = null, string|null $business_connection_id = null, CURLFile|string|object|null $thumbnail = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must be same with the format of the stickers in the set. Returns True on success.
 ...
 * @method static string|responseError createInvoice (string|array $title, string $description, string $payload, string $currency, labeledPrice[] $prices, string|null $provider_token = null, int|null $max_tip_amount = null, int[]|null $suggested_tip_amounts = null, string|null $provider_data = null, string|null $photo_url = null, int|null $photo_size = null, int|null $photo_width = null, int|null $photo_height = null, bool|null $need_name = null, bool|null $need_phone_number = null, bool|null $need_email = null, bool|null $need_shipping_address = null, bool|null $send_phone_number_to_provider = null, bool|null $send_email_to_provider = null, bool|null $is_flexible = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to create a link for an invoice. Returns the created invoice link as String on success.
 ...
 * @method static bool|responseError refundStarPayment (string|array $telegram_payment_charge_id, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Refunds a successful payment in Telegram Stars. Returns True on success.
 * @method static bool|responseError refundPayment (string|array $telegram_payment_charge_id, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Refunds a successful payment in Telegram Stars. Returns True on success.
 * @method static bool|responseError refundStar (string|array $telegram_payment_charge_id, int|null $user_id = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Refunds a successful payment in Telegram Stars. Returns True on success.
...
class request {
    ...
    private const METHODS_ACTION = [
        ...
        'refundpayment'                     => 'refundStarPayment',
        'refundstar'                        => 'refundStarPayment',
    ...
    private const METHODS_KEYS = [
        ...
        'sendMessage'                       => ['text', 'chat_id', 'business_connection_id', 'message_thread_id', 'parse_mode', 'entities', 'link_preview_options', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'copyMessage'                       => ['chat_id', 'message_thread_id', 'from_chat_id', 'message_id', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendPhoto'                         => ['photo', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'has_spoiler', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAudio'                         => ['audio', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'performer', 'title', 'thumbnail', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendDocument'                      => ['document', 'chat_id', 'business_connection_id', 'message_thread_id', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'disable_content_type_detection', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideo'                         => ['video', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'has_spoiler', 'supports_streaming', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAnimation'                     => ['animation', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'has_spoiler', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVoice'                         => ['voice', 'chat_id', 'business_connection_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideoNote'                     => ['video_note', 'chat_id', 'business_connection_id', 'message_thread_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendMediaGroup'                    => ['media', 'chat_id', 'business_connection_id', 'message_thread_id', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendLocation'                      => ['latitude', 'longitude', 'chat_id', 'business_connection_id', 'message_thread_id', 'horizontal_accuracy', 'live_period', 'heading', 'proximity_alert_radius', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendContact'                       => ['phone_number', 'first_name', 'chat_id', 'business_connection_id', 'message_thread_id', 'last_name', 'vcard', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendDice'                          => ['chat_id', 'business_connection_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'editMessageCaption'                => ['chat_id', 'message_id', 'inline_message_id', 'caption', 'parse_mode', 'caption_entities', 'show_caption_above_media', 'reply_markup', 'token', 'forgot', 'answer'],
        'editMessageMedia'                  => ['media', 'chat_id', 'message_id', 'inline_message_id', 'reply_markup', 'token', 'forgot', 'answer'],
        'editMessageLiveLocation'           => ['latitude', 'longitude', 'chat_id', 'message_id', 'inline_message_id', 'live_period', 'horizontal_accuracy', 'heading', 'proximity_alert_radius', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'sendSticker'                       => ['sticker', 'chat_id', 'business_connection_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'refundStarPayment'                 => ['telegram_payment_charge_id', 'user_id', 'token', 'forgot', 'answer'],
        'setPassportDataErrors'             => ['errors', 'user_id', 'token', 'forgot', 'answer'],
        'sendGame'                          => ['game_short_name', 'chat_id', 'business_connection_id', 'message_thread_id', 'disable_notification', 'protect_content', 'message_effect_id', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
    ...
    public static function sendFile (string $file_id, int|string $chat_id = null, string|null $business_connection_id = null, int $message_thread_id = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $disable_notification = null, bool $protect_content = null, array|object $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|stdClass|array $reply_markup = null, string $token = null, bool $forgot = null, bool $answer = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null): message|bool|responseError {
        ...
        return match ($type) {
            ...
            fileTypes::VIDEO_NOTE => request::sendVideoNote(video_note: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::ANIMATION => request::sendAnimation(animation: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, caption: $caption, parse_mode: $parse_mode, caption_entities: $caption_entities, has_spoiler: false, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::AUDIO => request::sendAudio(audio: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, caption: $caption, parse_mode: $parse_mode, caption_entities: $caption_entities, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::PHOTO, fileTypes::PROFILE_PHOTO => request::sendPhoto(photo: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, caption: $caption, parse_mode: $parse_mode, caption_entities: $caption_entities, has_spoiler: false, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::VOICE => request::sendVoice(voice: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, caption: $caption, parse_mode: $parse_mode, caption_entities: $caption_entities, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::STICKER => request::sendSticker(sticker: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            fileTypes::DOCUMENT => request::sendDocument(document: $file_id, chat_id: $chat_id, business_connection_id: $business_connection_id, message_thread_id: $message_thread_id, caption: $caption, parse_mode: $parse_mode, caption_entities: $caption_entities, disable_notification: $disable_notification, protect_content: $protect_content, reply_parameters: $reply_parameters, reply_markup: $reply_markup, token: $token, forgot: $forgot, answer: $answer, reply_to_message_id: $reply_to_message_id, allow_sending_without_reply: $allow_sending_without_reply),
            default => false,
        };
    }
}
