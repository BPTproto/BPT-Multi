 ...
 * @method static bool|responseError setChatMenuButton (int|array|null $chat_id = null, menuButton|object|null $menu_button = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to change the bot's menu button in a private chat, or the default menu button. Returns True on success.
 * @method static bool|responseError setMenuButton (int|array|null $chat_id = null, menuButton|object|null $menu_button = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to change the bot's menu button in a private chat, or the default menu button. Returns True on success.
 * @method static bool|responseError setMenu (int|array|null $chat_id = null, menuButton|object|null $menu_button = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to change the bot's menu button in a private chat, or the default menu button. Returns True on success.
 * @method static bool|responseError setButton (int|array|null $chat_id = null, menuButton|object|null $menu_button = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to change the bot's menu button in a private chat, or the default menu button. Returns True on success.
