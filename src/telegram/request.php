 ...
 * @method static bool|responseError promoteChatMember (int|string|array|null $chat_id = null, int|null $user_id = null, bool|null $is_anonymous = null, bool|null $can_manage_chat = null, bool|null $can_delete_messages = null, bool|null $can_manage_video_chats = null, bool|null $can_restrict_members = null, bool|null $can_promote_members = null, bool|null $can_change_info = null, bool|null $can_invite_users = null, bool|null $can_post_messages = null, bool|null $can_edit_messages = null, bool|null $can_pin_messages = null, bool|null $can_post_stories = null, bool|null $can_edit_stories = null, bool|null $can_delete_stories = null, bool|null $can_manage_topics = null, string|null $token = null, bool|null $forgot = null, bool|null $answer = null) Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights. Pass False for all boolean parameters to demote a user. Returns True on success.
...
class request {
    ...
    private const METHODS_KEYS = [
        ...
        'sendMessage'                       => ['text', 'chat_id', 'message_thread_id', 'parse_mode', 'entities', 'link_preview_options', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendPhoto'                         => ['photo', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAudio'                         => ['audio', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'performer', 'title', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendDocument'                      => ['document', 'chat_id', 'message_thread_id', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'disable_content_type_detection', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideo'                         => ['video', 'chat_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'supports_streaming', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendAnimation'                     => ['animation', 'chat_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVoice'                         => ['voice', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVideoNote'                     => ['video_note', 'chat_id', 'message_thread_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendMediaGroup'                    => ['media', 'chat_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendLocation'                      => ['latitude', 'longitude', 'chat_id', 'message_thread_id', 'horizontal_accuracy', 'live_period', 'heading', 'proximity_alert_radius', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendVenue'                         => ['latitude', 'longitude', 'title', 'address', 'chat_id', 'message_thread_id', 'foursquare_id', 'foursquare_type', 'google_place_id', 'google_place_type', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        'sendContact'                       => ['phone_number', 'first_name', 'chat_id', 'message_thread_id', 'last_name', 'vcard', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendDice'                          => ['chat_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'promoteChatMember'                 => ['chat_id', 'user_id', 'is_anonymous', 'can_manage_chat', 'can_delete_messages', 'can_manage_video_chats', 'can_restrict_members', 'can_promote_members', 'can_change_info', 'can_invite_users', 'can_post_messages', 'can_edit_messages', 'can_pin_messages', 'can_post_stories', 'can_edit_stories', 'can_delete_stories', 'can_manage_topics', 'token', 'forgot', 'answer'],
        ...
        'sendSticker'                       => ['sticker', 'chat_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
        ...
        'sendGame'                          => ['game_short_name', 'chat_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer', 'reply_to_message_id', 'allow_sending_without_reply'],
    ...
    public static function sendFile (string $file_id, int|string $chat_id = null, int $message_thread_id = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $disable_notification = null, bool $protect_content = null, array|object $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|stdClass|array $reply_markup = null, string $token = null, bool $forgot = null, bool $answer = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null): message|bool|responseError {
        ...
        return match ($type) {
            fileTypes::VIDEO => request::sendVideo($file_id, $chat_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false,null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::VIDEO_NOTE => request::sendVideoNote($file_id, $chat_id, $message_thread_id, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::ANIMATION => request::sendAnimation($file_id, $chat_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::AUDIO => request::sendAudio($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::PHOTO, fileTypes::PROFILE_PHOTO => request::sendPhoto($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::VOICE => request::sendVoice($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::STICKER => request::sendSticker($file_id, $chat_id, $message_thread_id, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            fileTypes::DOCUMENT => request::sendDocument($file_id, $chat_id, $message_thread_id, null, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer, $reply_to_message_id, $allow_sending_without_reply),
            default => false,
        };
    }
}
