...
class request {
    ...
    private const METHODS_KEYS = [
        ...
        'sendMessage'                       => ['text', 'chat_id', 'message_thread_id', 'parse_mode', 'entities', 'link_preview_options', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'copyMessage'                       => ['chat_id', 'message_thread_id', 'from_chat_id', 'message_id', 'caption', 'parse_mode', 'caption_entities', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'sendPhoto'                         => ['photo', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendAudio'                         => ['audio', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'performer', 'title', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendDocument'                      => ['document', 'chat_id', 'message_thread_id', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'disable_content_type_detection', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendVideo'                         => ['video', 'chat_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'supports_streaming', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendAnimation'                     => ['animation', 'chat_id', 'message_thread_id', 'duration', 'width', 'height', 'thumbnail', 'caption', 'parse_mode', 'caption_entities', 'has_spoiler', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendVoice'                         => ['voice', 'chat_id', 'message_thread_id', 'caption', 'parse_mode', 'caption_entities', 'duration', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendVideoNote'                     => ['video_note', 'chat_id', 'message_thread_id', 'duration', 'length', 'thumbnail', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendMediaGroup'                    => ['media', 'chat_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'token', 'forgot', 'answer'],
        'sendLocation'                      => ['latitude', 'longitude', 'chat_id', 'message_thread_id', 'horizontal_accuracy', 'live_period', 'heading', 'proximity_alert_radius', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendVenue'                         => ['latitude', 'longitude', 'title', 'address', 'chat_id', 'message_thread_id', 'foursquare_id', 'foursquare_type', 'google_place_id', 'google_place_type', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendContact'                       => ['phone_number', 'first_name', 'chat_id', 'message_thread_id', 'last_name', 'vcard', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendPoll'                          => ['question', 'options', 'chat_id', 'message_thread_id', 'is_anonymous', 'type', 'allows_multiple_answers', 'correct_option_id', 'explanation', 'explanation_parse_mode', 'explanation_entities', 'open_period', 'close_date', 'is_closed', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        'sendDice'                          => ['chat_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'sendSticker'                       => ['sticker', 'chat_id', 'message_thread_id', 'emoji', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
        ...
        'sendGame'                          => ['game_short_name', 'chat_id', 'message_thread_id', 'disable_notification', 'protect_content', 'reply_parameters', 'reply_markup', 'token', 'forgot', 'answer'],
    ...
    public static function sendFile (string $file_id, int|string $chat_id = null, int $message_thread_id = null, string $caption = null, string $parse_mode = null, array $caption_entities = null, bool $disable_notification = null, bool $protect_content = null, array|object $reply_parameters = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|stdClass|array $reply_markup = null, string $token = null, bool $forgot = null, bool $answer = null): message|bool|responseError {
        ...
        return match ($type) {
            fileTypes::VIDEO => request::sendVideo($file_id, $chat_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false,null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::VIDEO_NOTE => request::sendVideoNote($file_id, $chat_id, $message_thread_id, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::ANIMATION => request::sendAnimation($file_id, $chat_id, $message_thread_id, null, null, null, null, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::AUDIO => request::sendAudio($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, null, null, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::PHOTO, fileTypes::PROFILE_PHOTO => request::sendPhoto($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, false, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::VOICE => request::sendVoice($file_id, $chat_id, $message_thread_id, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::STICKER => request::sendSticker($file_id, $chat_id, $message_thread_id, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            fileTypes::DOCUMENT => request::sendDocument($file_id, $chat_id, $message_thread_id, null, $caption, $parse_mode, $caption_entities, null, $disable_notification, $protect_content, $reply_parameters, $reply_markup, $token, $forgot, $answer),
            default => false,
        };
    }
}
