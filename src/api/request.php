 ...
 * @method static messageId|responseError copymessage (int|string|array $chat_id, int|null $message_thread_id = null, int|string|null $from_chat_id = null, int|null $message_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to copy messages of any kind. Service messages and invoice messages can't be copied. The method is analogous to the method forwardMessage, but the copied message doesn't have a link to the original message. Returns the MessageId of the sent message on success.
 * @method static messageId|responseError copy (int|string|array $chat_id, int|null $message_thread_id = null, int|string|null $from_chat_id = null, int|null $message_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to copy messages of any kind. Service messages and invoice messages can't be copied. The method is analogous to the method forwardMessage, but the copied message doesn't have a link to the original message. Returns the MessageId of the sent message on success.
 * @method static message|responseError sendphoto (CURLFile|string|array $photo, int|string|null $chat_id = null, int|null $message_thread_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to send photos. On success, the sent Message is returned.
 * @method static message|responseError photo (CURLFile|string|array $photo, int|string|null $chat_id = null, int|null $message_thread_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to send photos. On success, the sent Message is returned.
 * @method static message|responseError sendaudio (CURLFile|string|array $audio, int|string|null $chat_id = null, int|null $message_thread_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, int|null $duration = null, string|null $performer = null, string|null $title = null, CURLFile|string|null $thumb = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to send audio files, if you want Telegram clients to display them in the music player. Your audio must be in the .MP3 or .M4A format. On success, the sent Message is returned. Bots can currently send audio files of up to 50 MB in size, this limit may be changed in the future. For sending voice messages, use the sendVoice method instead.
 ...
 * @method static message|responseError sendvoice (CURLFile|string|array $voice, int|string|null $chat_id = null, int|null $message_thread_id = null, string|null $caption = null, string|null $parse_mode = null, messageEntity[]|null|stdClass[]|array $caption_entities = null, int|null $duration = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .OGG file encoded with OPUS (other formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
 ...
 * @method static message|responseError sendvenue (int|string|array $chat_id, float|stdClass $latitude, float|stdClass $longitude, string $title, string $address, int|null $message_thread_id = null, string|null $foursquare_id = null, string|null $foursquare_type = null, string|null $google_place_id = null, string|null $google_place_type = null, bool|null $disable_notification = null, bool|null $protect_content = null, int|null $reply_to_message_id = null, bool|null $allow_sending_without_reply = null, inlineKeyboardMarkup|replyKeyboardMarkup|replyKeyboardRemove|forceReply|null|stdClass|array $reply_markup = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to send information about a venue. On success, the sent Message is returned.
 ...
 * @method static sticker[]|responseError getforumtopiciconstickers (string|null|array $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get custom emoji stickers, which can be used as a forum topic icon by any user. Requires no parameters. Returns an Array of Sticker objects.
 * @method static sticker[]|responseError gettopicstickers (string|null|array $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to get custom emoji stickers, which can be used as a forum topic icon by any user. Requires no parameters. Returns an Array of Sticker objects.
 * @method static forumTopic|responseError createforumtopic (int|string|array $chat_id, string $name, int|null $icon_color = null, string|null $icon_custom_emoji_id = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to create a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns information about the created topic as a ForumTopic object.
 * @method static forumTopic|responseError createtopic (int|string|array $chat_id, string $name, int|null $icon_color = null, string|null $icon_custom_emoji_id = null, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to create a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights. Returns information about the created topic as a ForumTopic object.
 * @method static bool|responseError editforumtopic (int|string|array $chat_id, int $message_thread_id, string $name, string $icon_custom_emoji_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError edittopic (int|string|array $chat_id, int $message_thread_id, string $name, string $icon_custom_emoji_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to edit name and icon of a topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError closeforumtopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError closetopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError reopenforumtopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to reopen a closed topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError reopentopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to reopen a closed topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_manage_topics administrator rights, unless it is the creator of the topic. Returns True on success.
 * @method static bool|responseError deleteforumtopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to delete a forum topic along with all its messages in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_delete_messages administrator rights. Returns True on success.
 * @method static bool|responseError deletetopic (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to delete a forum topic along with all its messages in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the can_delete_messages administrator rights. Returns True on success.
 * @method static bool|responseError unpinallforumtopicmessages (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to clear the list of pinned messages in a forum topic. The bot must be an administrator in the chat for this to work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
 * @method static bool|responseError unpintopicmessages (int|string|array $chat_id, int $message_thread_id, string|null $token = null, bool|null $return_array = null, bool|null $forgot = null, bool|null $answer = null) Use this method to clear the list of pinned messages in a forum topic. The bot must be an administrator in the chat for this to work and must have the can_pin_messages administrator right in the supergroup. Returns True on success.
 */
class request {
    ...
    private const METHODS_KEYS = [
        ...
        'closeForumTopic'                 => ['chat_id', 'message_thread_id', 'token', 'return_array', 'forgot', 'answer'],
        'reopenForumTopic'                => ['chat_id', 'message_thread_id', 'token', 'return_array', 'forgot', 'answer'],
        'deleteForumTopic'                => ['chat_id', 'message_thread_id', 'token', 'return_array', 'forgot', 'answer'],
        'unpinAllForumTopicMessages'      => ['chat_id', 'message_thread_id', 'token', 'return_array', 'forgot', 'answer']
    ];
